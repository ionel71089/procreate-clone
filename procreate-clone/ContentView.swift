...
struct ContentView: View {
    ...
    @ObservedObject var imageViewModel = ThermalImageViewModel(path: Bundle.main.url(forResource: "desk.jpg", withExtension: nil)!.path)
        ...
        VStack(spacing: 0) {
            ...
            ZStack {
                ...
                ThermalImageView(revealValue: $viewModel.revealValue,
                    ...
                    .frame(width: imageViewModel.imageSize.width, height: imageViewModel.imageSize.height)
                    .scaleEffect(scale)
